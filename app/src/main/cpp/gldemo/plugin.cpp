...
static constexpr std::chrono::microseconds vsync_period {std::size_t(NANO_SEC/60)};
	...
	void _p_one_iteration() override {
		{
            ...
            auto fast_pose_sample_time = std::chrono::system_clock::now();
...
private:
	...
	int createSharedEyebuffer(GLuint* texture_handle){
		...
		//Modified, CLAMP_TO_BORDER not available in OpenGL ES.
