...
public:
    ...
    EGLContext get_primary_context() const { return primary_context_; }

    /// Check if primary context is registered
    bool is_initialized() const { return primary_context_ != EGL_NO_CONTEXT; }
...
public:
    gl_context_guard() : success_(false) {
