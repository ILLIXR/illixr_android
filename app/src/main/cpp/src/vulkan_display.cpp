...
void display_vk::start(std::set<const char*> instance_extensions, std::set<const char*> device_extensions) {
...
void display_vk::setup(std::set<const char*> instance_extensions, std::set<const char*> device_extensions) {
    ...
    backend_ = std::make_shared<display::android_display>();
#else
...
void display_vk::create_vk_instance(const std::set<const char*>& instance_extensions) {
...
bool display_vk::is_physical_device_suitable(const VkPhysicalDevice& physical_device) {
...
void display_vk::select_physical_device() {
...
void display_vk::create_logical_device(const std::set<const char*>& device_extensions) {
...
void display_vk::create_swapchain() {
    // create surface
...
void display_vk::destroy_swapchain() {
