...
#if defined VIO
    auto nvvideoconvert_0 = gst_element_factory_make(ILLIXR_VIDEO_CONVERT, "nvvideoconvert0");
    auto nvvideoconvert_1 = gst_element_factory_make(ILLIXR_VIDEO_CONVERT, "nvvideoconvert1");
