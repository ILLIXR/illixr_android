//
// Created by madhuparna on 8/31/22.
//

#ifndef ILLIXR_NATIVE_ACTIVITY_NATIVECLASS_H
#define ILLIXR_NATIVE_ACTIVITY_NATIVECLASS_H
...
//
//        static std::shared_ptr <NativeObject>
//        create(std::function<void(const std::shared_ptr <mog::List> &args)> func);
//
//        ~NativeObject();
//
//        void *getValue();
...
//        template<class T, typename std::enable_if<std::is_base_of<Data, T>::value>::type *& = enabler>
//        std::shared_ptr <T>
//        executeWithList(std::string methodName, const std::shared_ptr <mog::List> &args) {
...
//
//        std::shared_ptr <mog::Data>
//        executeMain(std::string methodName, const std::shared_ptr <mog::List> &args,
//                    DataType retType);
//
...
//        void
//        appendArg(std::shared_ptr <mog::List> &args, const First &first, const Rest &... rest) {
//            args->append(first);
...
//}
#endif //ILLIXR_NATIVE_ACTIVITY_NATIVECLASS_H
