...
const char* const timeWarpChromaticVertexProgramGLSL =
		...
		"\n "
		"\n // Incoming"
		"\n attribute vec4 a_position;      // vertex position in 2d Model Space"
	...
	//	"\n attribute gl_PerVertex { vec4 gl_Position; };"
		...
		"\n	float displayFraction = vertexPosition.x * 0.5 + 0.5;"	// landscape left-to-right
...
//	"void main()\n"
//	"{\n"
//	"\n	outColor.r = 0.0; //texture( Texture, fragmentUv0 ).r;\n"
//	"\n	outColor.g = 0.0; //texture( Texture, fragmentUv1 ).g;\n"
//	"\n	outColor.b = 1.0;//texture( Texture, fragmentUv2 ).b;\n"
//	"\n	outColor.a = 1.0;\n"
//	"}\n";
