...
set_target_properties(spdlog::spdlog_android PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/armeabi-v7a/libspdlog_android.so"
  IMPORTED_SONAME_RELEASE "libspdlog_android.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS spdlog::spdlog_android )
list(APPEND _IMPORT_CHECK_FILES_FOR_spdlog::spdlog_android "${_IMPORT_PREFIX}/armeabi-v7a/libspdlog_android.so" )
